...
import { CardType, TransactionItemType } from '../../types';
import { CardIcon, CreditcardIcon, InvestmentIocn, LoanIcon, Paypal, Privileges, ServiceIcon, TransactionIcon } from '../components/Icons';
...
export const SideBarItems = [
  ...
  export const transactions: TransactionItemType[] = [
    { id: 1, name: "Deposit from my Card", date: "28 January 2021", amount: -850, type: "expense", Icon : CardIcon },
    { id: 2, name: "Deposit Paypal", date: "25 January 2021", amount: 2500, type: "income",  Icon : Paypal  },
    { id: 3, name: "Jemi Wilson", date: "21 January 2021", amount: 5400, type: "income", Icon : CardIcon  },
  ];
